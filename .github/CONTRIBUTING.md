...
First of all, thanks for your interest in contributing to the tslint-config! 🎉
...
By contributing your code to the tslint-config GitHub Repository, you agree to license your contribution under the MIT license.
